	...
	<div class="container-fullwidth">
		<div class="row">
			<div class="account col-md-6 col-md-offset-3">
				<h1 class="well text-center">Withdraw amount</h1>
				<div class="col-lg-12 well">
					<div class="row">
						<form:form action="customerwithdraw" modelAttribute = "customer" method="post">
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-6 form-group">
										<label>acount_no</label> <input path = "account_no" type="text"
											placeholder="Enter accont number" class="form-control"
											name="account_no">
									</div>
									<div class="col-sm-6 form-group">
