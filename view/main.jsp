...
@media ( max-width : 880px) {
  ...
  <body data-spy="scroll" data-target="#navbar" data-offset="150">
        ...
        <nav class="navbar navbar-light bg-faded navbar-fixed-top" id="navbar">
          ...
          <form class="form-inline pull-xs-right" action="${pageContext.request.contextPath}/log/logindone" modelAttribute="login" method="post">
            <input class="form-control"  placeholder="accout number" name = "account_no">
